...
public class AppointmentBeanConfig {
    ...
    @Bean
    CreateAppointmentUseCase createAppointmentUseCase(CustomAppointmentRepository customAppointmentRepository, UserServiceClientPort userServiceClientPort, AppointmentQueuePort appointmentQueuePort) {
        return new CreateAppointmentUseCaseImpl(customAppointmentRepository, userServiceClientPort, appointmentQueuePort);
    }

    @Bean
    UpdateAppointmentUseCase updateAppointmentUseCase(CustomAppointmentRepository customAppointmentRepository, AppointmentQueuePort appointmentQueuePort) {
        return new UpdateAppointmentUseCaseImpl(customAppointmentRepository, appointmentQueuePort);
    }
