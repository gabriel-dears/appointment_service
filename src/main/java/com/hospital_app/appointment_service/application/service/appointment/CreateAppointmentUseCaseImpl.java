...
public class CreateAppointmentUseCaseImpl implements CreateAppointmentUseCase {
    ...
    public CreateAppointmentUseCaseImpl(CustomAppointmentRepository customAppointmentRepository, UserServiceClientPort userServiceClientPort, AppointmentQueuePort appointmentQueuePort) {
    ...
    public Appointment execute(Appointment appointment) {
        ...
        appointmentQueuePort.sendAppointment(createdAppointment);
